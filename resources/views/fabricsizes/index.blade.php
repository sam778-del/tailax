...
@section('page-title', __('Fabric Sizes List') )
    ...
    <div class="row mb-3 align-items-center">
        <div class="col">
            <ol class="breadcrumb bg-transparent mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ __('Fabric Sizes') }}</li>
            </ol>
        </div>
    </div>
    <!-- .row end -->
    ...
    <div class="col-12">
        <div class="card-body border-bottom">
            <div class="row align-items-center">
                ...
                {{-- End of other widget --}}
                @can('Create Fabric Size')
                    <div class="col-auto d-none d-md-inline-block">
                        <a href="{{ route("fabric_sizes.create") }}" class="btn btn-primary">
                            <i class="bi bi-plus-lg"></i>
                            {{ __('Create Fabric Size') }}
                        </a>
                    </div>
                @endcan
            </div>
        ...
        $(document).ready(function() {
            var table = $('#table_list')
                ...
                .dataTable( {
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: '{{ route('fabric.size.datatables') }}',
                    columns: [
                        { data: 'name', name: 'name' },
