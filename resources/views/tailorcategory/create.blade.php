...
@section('page-title', __('Tailor Categories Create') )
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4><a href="{{ route("tailor_categories.index") }}" class="fa fa-arrow-circle-left me-2" title="{{ __('Create Tailor Categories') }}"></a>{{ __('Create Tailor Categories') }}</h4>
                ...
                <div class="card-body">
                    {!! Form::open(["route" => ["tailor_categories.store"], "method" => "POST", "id" => "submit-form"]) !!}
                    <div class="row mb-4">
                        <label class="col-xl-2 col-sm-3 col-form-label">{{ __('Category Name') }} *</label>
                        <div class="col-xl-8 col-sm-9">
                            {!! Form::text('name', null, ["class" => "form-control form-control-lg", "placeholder" => __('Category Name')]) !!}
                        </div>
                    </div>
                    <div class="row">
