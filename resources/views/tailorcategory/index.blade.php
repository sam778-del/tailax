...
@section('page-title', __('Tailor Categories List') )
    ...
    <div class="row mb-3 align-items-center">
        <div class="col">
            <ol class="breadcrumb bg-transparent mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ __('Tailor Categories Stages') }}</li>
            </ol>
        </div>
    </div>
    <!-- .row end -->
    ...
    <div class="col-12">
        <div class="card-body border-bottom">
            <div class="row align-items-center">
                ...
                {{-- End of other widget --}}
                @can('Create Tailor Categories')
                    <div class="col-auto d-none d-md-inline-block">
                        <a href="{{ route("tailor_categories.create") }}" class="btn btn-primary">
                            <i class="bi bi-plus-lg"></i>
                            {{ __('Create Tailor Category') }}
                        </a>
                    </div>
                @endcan
            </div>
        ...
        $(document).ready(function() {
            var table = $('#table_list')
                ...
                .dataTable( {
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: '{{ route('tailor.category.datatables') }}',
                    columns: [
                        { data: 'name', name: 'name' },
