               ...
               <div class="row">
                  <div class="col-lg-5 d-none d-lg-flex justify-content-center align-items-center">
                     <div style="max-width: 35rem;">
                        <div class="mb-4">
                           <svg height="100" viewBox="0 0 67 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="mb-2">
                            <a href="#" class="me-3 color-600"><span class="flag-icon flag-icon-gb"></span> UK</a>
                            <a href="#" class="me-3 color-600"><span class="flag-icon flag-icon-us"></span> EN</a>
                            <a href="#" class="me-3 color-600"><span class="flag-icon flag-icon-de"></span> GE</a>
                            <a href="#" class="me-3 color-600"><span class="flag-icon flag-icon-in"></span> HI</a>
                            <a href="#" class="me-3 color-600"><span class="flag-icon flag-icon-sa"></span> SA</a>
                        </div>
                     </div>
                  </div>
                  @yield('auth-content')
