    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4><a href="{{ route("customers.index") }}" class="fa fa-arrow-circle-left me-2" title="{{ __('Edit Customer') }}"></a>{{ __('Edit Customer') }}</h4>
            ...
            <div class="card-body">
                {!! Form::open(["route" => ["customers.update", $customer->id], "method" => "PATCH", "id" => "submit-form", "enctype" => "multipart/form-data"]) !!}
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-xl-8 col-sm-9">
                        {!! Form::text('customer_name', $customer->name, ["class" => "form-control form-control-lg", "placeholder" => __('Customer Name')]) !!}
                    </div>
                </div>
                <div class="row mb-4">
                    <label class="col-xl-2 col-sm-3 col-form-label">{{ __('Customer Email') }} *</label>
                    <div class="col-xl-8 col-sm-9">
                        {!! Form::email('customer_email', $customer->email, ["class" => "form-control form-control-lg", "placeholder" => __('Customer Email')]) !!}
                    </div>
                </div>
                <div class="row mb-4">
                    <label class="col-xl-2 col-sm-3 col-form-label">{{ __('Phone Number') }} *</label>
                    <div class="col-xl-8 col-sm-9">
                        {!! Form::number('customer_phone_number', $customer->phone_number, ["class" => "form-control form-control-lg", "placeholder" => __('Phone Number')]) !!}
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-xl-8 col-sm-9">
                        {!! Form::textarea('customer_address', $customer->address, ["class" => "form-control form-control-lg", "rows" => 4]) !!}
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-xl-2 col-sm-3 col-form-label">{{ __('Customer Description') }}</label>
                    <div class="col-xl-8 col-sm-9">
                        {!! Form::textarea('customer_description', $customer->description, ["class" => "form-control form-control-lg", "rows" => 4]) !!}
                    </div>
                </div>
                <div class="row">
