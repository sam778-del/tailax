...
@section('page-title', __('Production Stages Create') )
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4><a href="{{ route("production_stages.index") }}" class="fa fa-arrow-circle-left me-2" title="{{ __('Create Production Stages') }}"></a>{{ __('Create Production Stages') }}</h4>
                ...
                <div class="card-body">
                    {!! Form::open(["route" => ["production_stages.store"], "method" => "POST", "id" => "submit-form"]) !!}
                    <div class="row mb-4">
                        <label class="col-xl-2 col-sm-3 col-form-label">{{ __('Process Name') }} *</label>
                        <div class="col-xl-8 col-sm-9">
                            {!! Form::text('process_name', null, ["class" => "form-control form-control-lg", "placeholder" => __('Process Name')]) !!}
                        </div>
                    </div>
                    <div class="row">
