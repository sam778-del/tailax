...
@section('page-title', __('Production Stages List') )
    ...
    <div class="row mb-3 align-items-center">
        <div class="col">
            <ol class="breadcrumb bg-transparent mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ __('Production Stages') }}</li>
            </ol>
        </div>
    </div>
    <!-- .row end -->
    ...
    <div class="col-12">
        <div class="card-body border-bottom">
            <div class="row align-items-center">
                ...
                {{-- End of other widget --}}
                @can('Create Production Stage')
                    <div class="col-auto d-none d-md-inline-block">
                        <a href="{{ route("production_stages.create") }}" class="btn btn-primary">
        ...
        $(document).ready(function() {
            var table = $('#table_list')
                ...
                .dataTable( {
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: '{{ route('production.stage.datatables') }}',
                    columns: [
