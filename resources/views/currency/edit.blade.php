...
@section('page-title', __('Currencies Edit') )
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4><a href="{{ route("currencies.index") }}" class="fa fa-arrow-circle-left me-2" title="{{ __('Edit Currency') }}"></a>{{ __('Edit Currency') }}</h4>
            ...
            <div class="card-body">
                {!! Form::open(["route" => ["currencies.update", $currency->id], "method" => "PATCH", "id" => "submit-form"]) !!}
                <div class="row mb-4">
                    <label class="col-xl-2 col-sm-3 col-form-label">{{ __('Currency Name') }} *</label>
                    <div class="col-xl-8 col-sm-9">
                        {!! Form::text('currency_name', $currency->currecny_name, ["class" => "form-control form-control-lg", "placeholder" => __('Currency Name')]) !!}
                    </div>
                </div>
                <div class="row mb-4">
                    <label class="col-xl-2 col-sm-3 col-form-label">{{ __('Currency Symbol') }} *</label>
                    <div class="col-xl-8 col-sm-9">
                        {!! Form::text('currency_symbol', $currency->currency_symbol, ["class" => "form-control form-control-lg", "placeholder" => __('Currency Symbol')]) !!}
                    </div>
                </div>
                <div class="row mb-4">
                    <label class="col-xl-2 col-sm-3 col-form-label">{{ __('Exchange Rate') }} *</label>
                    <div class="col-xl-8 col-sm-9">
                        {!! Form::number('exchange_rate', $currency->amount, ["class" => "form-control form-control-lg", "placeholder" => __('Exchange Rate')]) !!}
                    </div>
                </div>
                <div class="row">
